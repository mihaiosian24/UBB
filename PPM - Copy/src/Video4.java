...
public class Video4 implements Runnable{
    public Video4 video;
    ...
    Video4(ColorImage colorImage, String name, String file, String output, double o, double[] cosinee, double cc, double cccc){
        this.file=file;
    ...
    public void setVideo2(Video4 video) throws IOException {
        if(this.video!=null){
...
//}
        ...
        newppm3 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
...
//}
        ...
        newppm4 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
...
//}
        ...
        newppm5 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
...
//}
        ...
        newppm9 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
...
//}
        ...
        newppm8 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
...
//}
        ...
        newppm7 = new Ppm(colorImage.width, colorImage.height, colorImage.getImage());
        try {
            //System.out.println("SCRIE");
            newppm3.writeFile(output, false);
        }catch(Exception e){
