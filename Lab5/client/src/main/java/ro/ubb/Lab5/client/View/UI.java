package ro.ubb.Lab5.client.View;
...
public class UI {
    ...
    public void showMenu(){
        ...
        System.out.println("8.Add BookStore.Client");
    ...
    public void addBook()throws sun.security.validator.ValidatorException{
        Book book=readBook();
        try{
            ctrl.addBook(book);
    ...
    public void updateBook()throws sun.security.validator.ValidatorException{
        Book book=readBook();
        try{
...
//
    public void addPurchased()throws sun.security.validator.ValidatorException{
...
//
    ...
    public void addClient()throws sun.security.validator.ValidatorException{
    ...
    public void updateClient()throws sun.security.validator.ValidatorException{
        Client client=readClient();
        try{
